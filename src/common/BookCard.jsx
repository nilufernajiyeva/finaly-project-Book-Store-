...
const BookCard = ({ book }) => {
  return (
    <div className="flex flex-col group cursor-pointer">
      <div className="relative aspect-[3/4] bg-[#F9F9F9] flex items-center justify-center p-4 overflow-hidden">        <img 
          src={book.imageUrl} 
          alt={book.title} 
          className="h-[85%] w-[80%] object-contain shadow-2xl transition-transform duration-300 group-hover:scale-105" 
        />
        <div className="absolute top-2 right-2 bg-[#D4A017] p-2 shadow-md hover:bg-black transition-colors z-20">
